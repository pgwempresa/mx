;(function () {
  ...
  function ensureStyle() {
    ...
    style.textContent = [
      ...
      '#'+SCREEN_ID+' .mbway-top{height:22px;background:#050505;color:#bdbdbd;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:800;letter-spacing:.03em;text-transform:uppercase;}',
      '#'+SCREEN_ID+' .mbway-content{padding:40px 30px 0;text-align:center;}',
      '#'+SCREEN_ID+' .mbway-brand{width:96px;height:96px;border-radius:999px;margin:0 auto 18px;background:#1554a4;display:flex;align-items:center;justify-content:center;overflow:hidden;}',
      ...
      '#'+SCREEN_ID+' .mbway-amount{font-size:48px;line-height:1;font-weight:950;letter-spacing:-.06em;color:#0f172a;margin:0;}',
      '#'+SCREEN_ID+' .mbway-line{height:1px;background:#e5e7eb;margin:40px 0 24px;}',
      '#'+SCREEN_ID+' .mbway-method{border:1px solid #d1d5db;border-radius:14px;padding:16px 17px;text-align:left;background:rgba(255,255,255,.35);}',
      '#'+SCREEN_ID+' .mbway-method small{display:block;font-size:12px;font-weight:800;color:#374151;margin-bottom:8px;}',
      '#'+SCREEN_ID+' .mbway-method-row{display:flex;align-items:center;gap:8px;font-size:17px;font-weight:900;color:#1554a4;margin-bottom:12px;}',
      '#'+SCREEN_ID+' .mbway-method-row img{width:62px;height:auto;object-fit:contain;}',
      '#'+SCREEN_ID+' .mbway-method p{font-size:14px;line-height:1.45;color:#374151;margin:0;}',
      '#'+SCREEN_ID+' .mbway-timer-card{margin:16px 16px 0;border:1px solid rgba(153,27,27,.35);border-radius:12px;padding:14px 12px 16px;background:rgba(254,242,242,.45);}',
      '#'+SCREEN_ID+' .mbway-timer-card p{margin:0;color:#7f1d1d;font-size:12px;font-weight:800;text-transform:uppercase;letter-spacing:.03em;}',
      '#'+SCREEN_ID+' .mbway-timer{font-size:36px;line-height:1;font-weight:950;color:#1554a4;margin:4px 0 8px;font-variant-numeric:tabular-nums;letter-spacing:.04em;}',
      '#'+SCREEN_ID+' .mbway-help{font-size:12px;line-height:1.35;color:#4b5563;margin:16px 0 0;}',
      '#'+SCREEN_ID+' .mbway-dim{position:absolute;inset:0;background:rgba(0,0,0,.48);}',
      '#'+SCREEN_ID+' .mbway-sheet-wrap{position:absolute;left:0;right:0;bottom:0;display:flex;justify-content:center;padding:0 16px;}',
      '#'+SCREEN_ID+' .mbway-sheet{width:100%;max-width:430px;background:#fff;border-radius:20px 20px 0 0;padding:24px 24px 34px;text-align:center;box-shadow:0 -16px 46px rgba(15,23,42,.18);}',
      '#'+SCREEN_ID+' .mbway-phone{width:22px;height:32px;border:3px solid #111827;border-radius:5px;margin:0 auto 16px;position:relative;}',
      ...
      '#'+SCREEN_ID+' .mbway-title{font-size:29px;line-height:1.18;font-weight:950;letter-spacing:-.04em;color:#111827;margin:0 auto 12px;max-width:330px;}',
