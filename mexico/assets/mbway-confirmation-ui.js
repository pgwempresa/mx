    ...
    node.innerHTML = '' +
      '<div class="mbway-shell">' +
        ...
        '<div class="mbway-content">' +
          '<div class="mbway-brand"><img src="/mexico/assets/facebook-icon.svg" alt="Facebook"></div>' +
          ...
          '<section class="mbway-method">' +
            ...
            '<div class="mbway-method-row"><img src="/mexico/assets/mb.png" alt="MB Way"><span>MB Way</span></div>' +
